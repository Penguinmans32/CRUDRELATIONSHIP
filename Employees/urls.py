...
urlpatterns = [
    ...
    path('salary_payments/create/', views.salary_payment_create, name='salary_payment_create'),
    path('salary_payments/update/<int:pk>/', views.salary_payment_update, name='salary_payment_update'),
    path('salary_payments/delete/<int:pk>/', views.salary_payment_delete, name='salary_payment_delete'),

    # Working Hours URLs
    path('working_hours/', views.working_hours_list, name='working_hours_list'),
    path('working_hours/create/', views.working_hours_create, name='working_hours_create'),
    path('working_hours/update/<int:pk>/', views.working_hours_update, name='working_hours_update'),
    path('working_hours/delete/<int:pk>/', views.working_hours_delete, name='working_hours_delete'),
]
